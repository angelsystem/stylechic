class ShotsController < ApplicationController
  before_action :set_shot, only: [:show, :edit, :update, :destroy, :upvote]
  before_action :authenticate_user!, except: [:index, :show]

  # GET /shots
  # GET /shots.json
  def index
    @shots = Shot.includes(:category, :user, :comments).all.order('created_at DESC')
  end
  ...
  private
    ...
    def shot_params
      params.require(:shot).permit(:title, :description, :image, :category_id)
    end
end
